function chatBotLib(tokenId = '97FE6493-A08A-47ED-BBFD-F6F9BE63422C', template = '', cssURL = 'chatbot-button-lib.css'){
    ...
    style.href = 'https://ps.cocos.si/demo/css/' + cssURL;
    ...
    function openChatBot() {
        ...
        if(!!chatPopup) {
            ...
            var callMeLink = 'https://ps.cocos.si/wp/cm/CallMe.html?tokenId=' + tokenId + '&chat=1&video=0&name=Visitor&callerDisplayName=Visitor&subject=Info&comment=&template=' + template + '&pageId=home';
